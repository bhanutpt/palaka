import { FONT_SIZE, type FontChoice, type Settings, type Theme } from './settings';
...
export function createSettingsDialog(
  ...
  for (const control of [theme, font, customFont, fontSize, digits, shortcut]) control.addEventListener('change', read);
